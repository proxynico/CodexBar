            ...
            allowCacheKeychainWrite: Bool = true) -> ClaudeOAuthCredentialRecord?
        {
            ...
            do {
                if ClaudeOAuthCredentialsStore.shouldPreferSecurityCLIKeychainRead() {
                    ...
                    let securityRead = ClaudeOAuthCredentialsStore.readClaudeKeychainViaSecurityCLIIfEnabled(
                    ...
                    case .unavailable:
                        break
                    case let .credentials(securityData):
                        ...
                        ClaudeOAuthCredentialsStore.log.info(
                            ...
                            metadata: ["interaction": interaction == .userInitiated ? "user" : "background"])
                        return ClaudeOAuthCredentialRecord(
                            credentials: creds,
                            owner: .claudeCLI,
                            source: .claudeKeychain)
